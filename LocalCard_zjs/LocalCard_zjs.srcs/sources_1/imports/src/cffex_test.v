...
// Author      : liuchaofan
// Called by   :
// Description : ht_cffex_test mode top module
// Date        : 2020-07-030
// Verson      : 1.0
// --------------------------------------------------------------------------------
// Verson Description
// 1.00   2020-07-30       The initial verson
// --------------------------------------------------------------------------------
module cffex_test #(
...
parameter VERSION_NUM = 32'h0000_0000;
...
md_filter #(
    ...
    //output net port
    .o_tx_data_net        ( tx_data_net[63:0]         ),
    .o_tx_len_net         ( tx_len_net[2:0]           ),
    .o_tx_sof_net         ( tx_sof_net[0]             ),
    .o_tx_eof_net         ( tx_eof_net[0]             ),
    .o_tx_vld_net         ( tx_vld_net[0]             ),
    .i_tx_ack_net         ( tx_ack_net[0]             ),
    //output dma port
    .o_tx_data_host       ( rx_data_host[63:0]        ),
    .o_tx_len_host        ( rx_len_host[2:0]          ),
    .o_tx_vld_host        ( rx_vld_host[0]            ),
    .o_tx_sof_host        ( rx_sof_host[0]            ),
    .o_tx_eof_host        ( rx_eof_host[0]            ),
    .o_tx_err_host        ( rx_err_host[0]            ),
    .o_tx_crc_fail_host   ( rx_crc_fail_host[0]       ),
    .o_tx_timestamp_host  ( rx_timestamp_host[31:0]   ),
    .o_tx_match_host      ( rx_match_host[7:0]        ),
    .o_tx_buffer_host     ( rx_buffer_host[5:0]       ),
    //stats
